...
git branch SQLSatWellington
git checkout SQLSatWellington

git status

# Add Changes to Invoke-DbaDatabaseShrink - https://github.com/sqlcollaborative/dbatools/issues/5108

git add *

git status

git commit -m "Changes to Invoke-DbaDatabaseShrink to resolve Issue 5108"

git status

git push origin SQLSatWellington
